...
import cPickle, gzip
import CIFARProcessingAndLoadingData as l
...
def load_data_shared():
	training_data,validation_data,testing_data = l.load_data_shared()
	...
	return [shared_variable(training_data),shared_variable(validation_data),shared_variable(testing_data)]
